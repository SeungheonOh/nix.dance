...
options=("haskell" "rust" "Quit")
select opt in "${options[@]}"; do case $opt in
"haskell") TAR="https://raw.githubusercontent.com/SeungheonOh/nix.dance/gh-pages/haskell.tar.gz"; break ;;
"rust") TAR="https://raw.githubusercontent.com/SeungheonOh/nix.dance/gh-pages/rust.tar.gz"; break ;;
